"""Qualify session capacity rollover from a source-bound pure wheel in an owned Windows process."""
...
from scripts.capacity_rollover import validate_capacity_rollover_v1
...
def main() -> None:
    ...
    receipt = CAPACITY_ROLLOVER_REGISTRATION_V1.produce(
        archive,
        identity,
        wheel,
    ...
    evidence = validate_capacity_rollover_v1(receipt)
    summary = {
        "schemaVersion": "capacity-rollover-summary-v1",
