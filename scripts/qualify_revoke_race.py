"""Qualify consent revocation from a source-bound pure wheel in an owned Windows process."""
...
from scripts.revoke_race import validate_revoke_race_v1
...
def main() -> None:
    ...
    receipt = REVOKE_RACE_REGISTRATION_V1.produce(
        archive,
        identity,
        wheel,
    ...
    evidence = validate_revoke_race_v1(receipt)
    summary = {
        "schemaVersion": "revoke-race-summary-v1",
