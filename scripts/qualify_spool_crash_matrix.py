"""Qualify all governed spool crash boundaries from a source-bound pure wheel."""
...
def main() -> None:
    ...
    receipt = SPOOL_CRASH_MATRIX_REGISTRATION_V1.produce(
        archive,
        identity,
        wheel,
    )
    evidence = validate_spool_crash_matrix_v1(receipt)
    summary = {
        "schemaVersion": "spool-crash-matrix-summary-v1",
